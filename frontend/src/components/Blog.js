...
const Blog = ({/* props about blog*/}) => 
{
    //   DISPLAYING ONLY FIRST 100 CHARACTERS OF BLOG WITH 
    const more = 
    {
        link: <a href="https://www.example.com">...More</a>
    };
      
    const completeBlogText ="In an ever-evolving world, technology continues to reshape the way we live, work, and connect with one another. From the rapid advancements in artificial intelligence and machine learning to the seamless integration of digital tools into our daily lives, the pace of change is astonishing. With each innovation, we find ourselves on the cusp of new possibilities and challenges. It's a time of both excitement and reflection as we navigate the complex interplay between the digital and physical realms. As we journey forward, it's crucial to harness the power of technology responsibly, ensuring it enhances our lives while preserving the values that make us human—empathy, creativity, and a sense of community.";
    const displayBlogText = completeBlogText.length > 100
    ?   (
            <span>
                {completeBlogText.slice(0, 150)}
                {more.link}
            </span>
        )
    :   completeBlogText;
    ...
    >
        <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
            ...
            <IconButton size="sm" variant="plain" color="neutral">
                <SvgIcon>
                <svg
                    xmlns="http://www.w3.org/2000/svg" // BLOGGER IMAGE
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                >
